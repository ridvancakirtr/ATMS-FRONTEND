...
export default {
  ...
  watch:{ 
    resetForm(value){
      if(value){
        this.form.tcknOrPassport=null;
        this.form.name=null;
        this.form.surname=null;
        this.form.email=null;
        this.form.type=null;
        this.form.lisanceNumber=null;
        this.form.lisanceType=null;
        this.form.address=null;
        this.form.gender= null;
        this.form.nationality= null;
        this.form.dateOfBirth= null;

        this.form.phone.countryCode=null;
        this.form.phone.nationalNumber=null;
        this.form.phone.countryCallingCode=null;
        this.form.phone.formattedNumber=null;
        this.form.phone.phoneNumber=null;
  ...
  computed: {
    resetForm(){
      return this.$store.state.employee.notification.status
    },
    countries(){
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="mb-3">
                    ...
                    <br />
                    <date-picker format="DD-MM-YYYY" placeholder="Doğum tarihini" v-model="form.dateOfBirth" :first-day-of-week="1" lang="tr"
                      :class="{
                          'is-invalid': formsubmit && $v.form.dateOfBirth.$error,
                      }">
                    </date-picker>
