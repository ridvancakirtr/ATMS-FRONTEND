...
export default {
  ...
  watch:{ 
    phoneNumber(){
      this.form.authorizedPhone.countryCode=this.agency.authorizedPhone.countryCode
      this.form.authorizedPhone.nationalNumber=this.agency.authorizedPhone.nationalNumber
      this.form.authorizedPhone.countryCallingCode=this.agency.authorizedPhone.countryCallingCode
      this.form.authorizedPhone.formattedNumber=this.agency.authorizedPhone.formattedNumber
      this.form.authorizedPhone.phoneNumber=this.agency.authorizedPhone.phoneNumber
    },
    results(a){
  ...
  methods: {
    submitForm() {
      ...
      this.$v.$touch();
      if (!this.$v.$invalid) {
          this.updateAgency({id:this.$route.params.id,form:this.form});
      }

    },
    setAgency(){
      this.form.companyName=this.agency.companyName
      this.form.taxAdministration=this.agency.taxAdministration
      this.form.taxNumber=this.agency.taxNumber
      this.form.address=this.agency.address
      this.form.authorizedName=this.agency.authorizedName
      this.form.authorizedSurname=this.agency.authorizedSurname
      this.form.authorizedEmail=this.agency.authorizedEmail

      this.phoneNumber=this.agency.authorizedPhone.nationalNumber
    },
    ...agencyMethod
  },
  validations: {
  ...
  async mounted() {
    await this.fetchAgency(this.$route.params.id)
    this.setAgency()
    this.isLoading=true
  },
};
